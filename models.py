...
class CNNModel(nn.Module): #standard "LeNet-style" architecture
    def __init__(self):
        ...
        # Layer 2: Looks for 32 different patterns by combining the previous 16 features
        self.conv2 = nn.Conv2d(16, 32, kernel_size=3, padding=1) # Combines those lines/edges into 32 complex shapes
        # Final Fully Connected Layers as a classifier
        self.fc = nn.Sequential(
            nn.Flatten(), # flatten to feed into the 10-digit output
            ...
            nn.Linear(128, 10) # Classifies those 128 concepts into 10 digits (0-9)
        )
